...
# 输出模型的准确度
print("精确度为：",decision_tree_classifier.score(X_test, Y_test)) 


# 使用训练的模型进行预测，为了方便，
# 案例直接把测试集里面的数据拿出来三条

print("预测数据为：",[[13.52,3.17,2.72,23.5,97],
[12.42,2.55,2.27,22,90],
[13.76,1.53,2.7,19.5,132]])#利用3个数据进行测试，即取3个数据作为模型的输入端
y=model.predict([[13.52,3.17,2.72,23.5,97],
[12.42,2.55,2.27,22,90],
[13.76,1.53,2.7,19.5,132]])#输出测试的结果，即输出模型预测的结果
